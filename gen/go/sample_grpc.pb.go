...
const (
	SampleService_GetSample_FullMethodName = "/sample.SampleService/GetSample"
)
...
type SampleServiceClient interface {
	GetSample(ctx context.Context, in *SampleMessage, opts ...grpc.CallOption) (*SampleMessage, error)
}
...
func (c *sampleServiceClient) GetSample(ctx context.Context, in *SampleMessage, opts ...grpc.CallOption) (*SampleMessage, error) {
...
type SampleServiceServer interface {
	GetSample(context.Context, *SampleMessage) (*SampleMessage, error)
...
func (UnimplementedSampleServiceServer) GetSample(context.Context, *SampleMessage) (*SampleMessage, error) {
...
func _SampleService_GetSample_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SampleServiceServer).GetSample(ctx, req.(*SampleMessage))
	}
